...
\solution The circuit can be designed using an operational amplifier having negative feedback.Consider the circuit shown in figure.\ref{fig:equivalent_control_system}:1
\begin{figure}[!ht]
	\begin{center}
...
\begin{align}
    R = 1000 \Omega
\end{align}
So, the final circuit is shown in figure.\ref{fig:final_circuit}:2.
\begin{figure}[!ht]
	\begin{center}
